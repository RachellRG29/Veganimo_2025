...
<body>
    ...
    <div class="tarj_crear_receta">
     ...
     <form action="guardar_recetaspro.php" id="form-receta-pro" class="form-receta" method="POST" enctype="multipart/form-data">

        <!-- Sección 1: Crear receta -->
        <div class="section active" id="section1">
            <h1 class="main-title">Crear recetas solicitud</h1>
        ...
        <div class="section" id="section3">
              ...
              <div class="buttons-container">
               ...
               <button type="submit" class="form-button btn-crear-receta">Enviar solicitud de receta</button>
              </div>
