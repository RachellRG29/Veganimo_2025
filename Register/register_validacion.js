document.addEventListener("DOMContentLoaded", function () {
  ...
  const nameRegex =
    /^([A-ZÁÉÍÓÚÑ][a-záéíóúñ]+)(\s[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+)*\s([A-ZÁÉÍÓÚÑ][a-záéíóúñ]+)(\s(de|De))?\s([A-ZÁÉÍÓÚÑ][a-záéíóúñ]+)$/;

  const emailRegex =
    /^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|hotmail\.com|outlook\.com|ugb\.edu\.sv|co\.sv|co\.uk|co\.nz|tv|me|int|io|info|us|sg|ca|au)\b$/;
  ...
  function validateFullname() {
    ...
    if (value === "") {
      ...
      showFieldError(
        fullnameInput,
        "Nombre inválido. Debe tener entre 3 y 5 palabras, cada una iniciando con mayúscula. " +
      ...
      if (hasDe) {
        ...
        console.log(
          "Nota: \"de\" o \"De\" se usa para indicar unión matrimonial entre apellidos.",
        );
      } else {
  ...
  function validatePassword() {
    ...
    passwordInput.style.borderColor =
      hasLength && hasUpper && hasNumber && hasSymbol && hasNoSpace
        ? "green"
        : "";
