...
try {
    if ($method === 'DELETE') {
        $id = $_GET['id'] ?? null;
        if (!$id) {
            throw new Exception('ID de receta no proporcionado');
        }
        ...
        if (isset($data['nombre_receta'])) {
            $updateFields['nombre_receta'] = $data['nombre_receta'];
        }
        if (isset($data['descripcion'])) {
            $updateFields['descripcion'] = $data['descripcion'];
        }
        if (isset($data['tiempo_preparacion'])) {
            $updateFields['tiempo_preparacion'] = $data['tiempo_preparacion'];
        }
        if (isset($data['dificultad'])) {
            $updateFields['dificultad'] = $data['dificultad'];
        }
        if (isset($data['categoria'])) {
            $updateFields['categoria'] = $data['categoria'];
        }
        if (isset($data['tipo_receta'])) {
            $updateFields['tipo_receta'] = $data['tipo_receta'];
        }
        if (isset($data['ingredientes']) && is_array($data['ingredientes'])) {
            $updateFields['ingredientes'] = $data['ingredientes'];
        }
