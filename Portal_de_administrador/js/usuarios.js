document.addEventListener("DOMContentLoaded", async function () {
  console.log("📦 usuarios.js cargado - Esperando contenido dinámico...");
  ...
  // Inicializar solo si estamos en la página de usuarios
  if (document.getElementById("tablaUsuarios")) {
    console.log("✅ Inicializando módulo de usuarios...");
    inicializarUsuarios();
  } else {
    console.log("❌ No se encontró tablaUsuarios, esperando carga dinámica...");
  }
});
...
function inicializarUsuarios() {
  ...
  if (!tablaUsuarios) {
    console.log("❌ tablaUsuarios no encontrado, saliendo...");
    return;
  }
  ...
  function cargarUsuarios() {
    ...
    fetch("/Portal_de_administrador/usuarios.php")
      .then((response) => {
  ...
  if (busquedaInput) {
    busquedaInput.addEventListener("input", function () {
      ...
      const resultados = usuariosData.filter(
        (usuario) =>
  ...
  function eliminarUsuario(idUsuario) {
    fetch(`/Portal_de_administrador/usuarios.php?id=${idUsuario}`, {
      method: "DELETE",
    })
      .then((response) => response.json())
      .then((data) => {
